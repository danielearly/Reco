...
public class ItemLookupSample {
    ...
    public static void main(String[] args) {
        ...
        params.put("AssociateTag", "reco047-20");
        ...
        String queryString = "Service=AWSECommerceService&Version=2009-03-31&Operation=ItemLookup&ResponseGroup=Small&AssociateTag=reco047-20&ItemId="
                + ITEM_ID;
